...
public class Activity7 {
	...
	@Test(priority = 3)
	public void empQualifications() throws InterruptedException {
		Thread.sleep(1000);
		...
		driver.findElement(By.id("experience_from_date")).sendKeys("2020-02-21");
		driver.findElement(By.id("experience_to_date")).clear();
		driver.findElement(By.id("experience_to_date")).sendKeys("2025-10-01");
		driver.findElement(By.id("experience_comments")).sendKeys("This is a sample Test");
